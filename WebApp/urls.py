...
from App.views import (
    ...
    AdminAnnouncementControlsView,
    AdminCategoryControlsView,
    AdminSiteAnnouncementSaveView,
    AdminSystemControlsView,
    AdminSystemAdminsView,
    AdminSystemAdminCreateView,
    AdminSystemAdminStatusUpdateView,
    ForgotPasswordView,
    HomeView,
    LoginView,
    LogoutView,
...
urlpatterns = [
    ...
    path('language/set/', SetLanguagePreferenceView.as_view(), name='set_language_preference'),
    ...
    path('admin/system-admins/', AdminSystemAdminsView.as_view(), name='admin_system_admins'),
    path('admin/system-admins/create/', AdminSystemAdminCreateView.as_view(), name='admin_system_admin_create'),
    path('admin/system-admins/<int:pk>/status/', AdminSystemAdminStatusUpdateView.as_view(), name='admin_system_admin_status_update'),
    path('admin/system-controls/category/', AdminCategoryControlsView.as_view(), name='admin_category_controls'),
    path('admin/system-controls/announcement/', AdminAnnouncementControlsView.as_view(), name='admin_announcement_controls'),
    path('admin/system-controls/announcement/save/', AdminSiteAnnouncementSaveView.as_view(), name='admin_site_announcement_save'),
